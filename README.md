...
REQUIRED: Airport code (to and from), date of departure, iteneraryType (one way or round trip), sort by (MY_BEST_VALUE, PRICE, EARLIEST_OUTBOUND_ARRIVAL, etc.), number of adults, number of seniors (65+), class (FIRST, BUSINESS, ECONOMY, PREMIUM_ECONOMY)

OPTIONAL: return date, child ages (as array), include nearby airports, nonstop trip, currency
...
```bash
{
  "status": true,
  "message": "Success",
  "timestamp": 1664044190673,
  "data": {
    "session": {
      "searchHash": "56725640dcbad41bc09cf029017e72bf",
      "pageLoadUid": "e8647876-0f3a-4f60-8d84-1fa65ef3163a",
      "searchId": "e0731fa2-dfc4-444a-8424-05e26c05dc2d.83"
    },
    "complete": false,
    "numOfFilters": 2698,
    "totalNumResults": 2698,
    "flights": [
      {
        "segments": [
          {
            "legs": [
              {
                ...
                "departureDateTime": "2022-10-07T12:25:00+05:30",
                "arrivalDateTime": "2022-10-07T14:20:00+05:30",
            ...
            "legs": [
              {
                ...
                "isDifferentDestinationStation": false,
                "departureDateTime": "2022-10-14T05:55:00+05:30",
                "arrivalDateTime": "2022-10-14T07:55:00+05:30",
                "classOfService": "ECONOMY",
                "marketingCarrierCode": "UK",
                "operatingCarrierCode": "UK",
                "amenities": [],
        ...
        "purchaseLinks": [
          {
            "purchaseLinkId": "SkyScanner|6|1564",
            "providerId": "Happyfares",
            "partnerSuppliedProvider": {
              "id": "2694934",
              "displayName": "Happyfares",
              "logoUrl": "https://s1.apideeplink.com/images/websites/hapf.png"
            },
            ...
            "totalPrice": 10270,
            "totalPricePerPassenger": 10270,
            "fareBasisCodes": [],
            "containedPurchaseLinks": [],
            "partnerData": {},
            "isPaid": false,
            "fareAttributesList": [],
            "url": "https://www.tripadvisor.com/CheapFlightsPartnerHandoff?searchHash=56725640dcbad41bc09cf029017e72bf&provider=SkyScanner|6|1564&area=FLTCenterColumn|0|1|ItinList|3|Meta_ItineraryPrice&resultsServlet=CheapFlightsSearchResults&handoffPlatform=desktop&impressionId=&totalPricePerPassenger=10270"
          }
        ]
      }
    ]
...
// Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse);
    ...
    public class Flight
    {
        ...
        public List<PurchaseLink> PurchaseLinks { get; set; }
    }

    public class Leg
    {
        public string OriginStationCode { get; set; }
        public bool IsDifferentOriginStation { get; set; }
        public string DestinationStationCode { get; set; }
        public bool IsDifferentDestinationStation { get; set; }
        ...
        public int SeatGuruEquipmentId { get; set; }
        public string SeatGuruAirlineUrl { get; set; }
        public int NumStops { get; set; }
        public double DistanceInKM { get; set; }
        public bool IsInternational { get; set; }
        public bool SelfTransfer { get; set; }
    ...
    public class PartnerSuppliedProvider
    {
    ...
    public class PurchaseLink
    {
        ...
        public PartnerSuppliedProvider PartnerSuppliedProvider { get; set; }
        ...
        public double TotalPricePerPassenger { get; set; }
        public List<object> FareBasisCodes { get; set; }
        public List<object> ContainedPurchaseLinks { get; set; }
        public PartnerData PartnerData { get; set; }
        public bool IsPaid { get; set; }
        public List<object> FareAttributesList { get; set; }
    ...
    public class Segment
    {
        ...
        public List<object> Layovers { get; set; }
    }
